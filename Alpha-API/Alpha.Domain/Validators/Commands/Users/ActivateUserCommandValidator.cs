...
{
    public class ActivateUserCommandValidator : CommandValidator<ActivateUserCommand>
    {
        public ActivateUserCommandValidator()
        {
            ...
            RuleFor(x => x.ActivationCode).NotEmpty().WithMessage(ValidationMessages.RequiredField.Formater("Código de Verificação"));
